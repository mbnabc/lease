...
import com.liurunqing.lease.web.admin.service.FacilityInfoService;
...
public class FacilityController {
    ...
    public Result<List<FacilityInfo>> listFacility(@RequestParam(required = false) ItemType type) {
        List<FacilityInfo> list = facilityInfoService.lambdaQuery()
                .eq(type != null, FacilityInfo::getType, type).list();
