...
import com.liurunqing.lease.web.admin.service.LabelInfoService;
...
public class LabelController {
    ...
    public Result<List<LabelInfo>> labelList(@RequestParam(required = false) ItemType type) {
        List<LabelInfo> list = labelInfoService.lambdaQuery()
                .eq(!ObjectUtils.isEmpty(type), LabelInfo::getType, type).list();
